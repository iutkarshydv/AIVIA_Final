# Create the ElevenLabs service (app/services/elevenlabs_service.py)
elevenlabs_service_py_content = '''"""
...
with open('elevenlabs_service.py', 'w') as f:
    f.write(elevenlabs_service_py_content)

print("✅ Created elevenlabs_service.py - ElevenLabs integration service")